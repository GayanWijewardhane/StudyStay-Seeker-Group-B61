...
export default function Search() {
  ...
  useEffect(() => {
    ...
    const accotypeFromUrl = urlParams.get('accotype');
  ...
  const handleChange = (e) => {
    ...
    if (
        ...
        setSidebardata({ ...sidebardata, accotype: e.target.id });
      }
  ...
  const handleSubmit = (e) => {
    ...
    urlParams.set('accotype', sidebardata.accotype);
          ...
          <div className='flex gap-2 flex-wrap items-center'>
            ...
            <div className='flex gap-2'>
              <input
                ...
                className='w-5'
                onChange={handleChange}
                checked={sidebardata.accotype === 'all'}
              />
              <span>All Type</span>
            </div>
            <div className='flex gap-2'>
              <input
                ...
                className='w-5'
                onChange={handleChange}
                checked={sidebardata.accotype === 'hostel'}
              />
              <span>Hostel</span>
            </div>
            <div className='flex gap-2'>
              <input
                ...
                className='w-5'
                onChange={handleChange}
                checked={sidebardata.accotype === 'room'}
              />
              <span>Room</span>
            </div>
            <div className='flex gap-2'>
              <input
                ...
                className='w-5'
                onChange={handleChange}
                checked={sidebardata.accotype === 'house'}
              />
              <span>House</span>
            </div>
          </div>
